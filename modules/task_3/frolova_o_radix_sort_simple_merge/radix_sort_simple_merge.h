...
#ifndef MODULES_TASK_3_FROLOVA_O_RADIX_SORT_SIMPLE_MERGE_RADIX_SORT_SIMPLE_MERGE_H_
#define MODULES_TASK_3_FROLOVA_O_RADIX_SORT_SIMPLE_MERGE_RADIX_SORT_SIMPLE_MERGE_H_
#include <mpi.h>
#include <vector>
#include <string>
...
#endif  // MODULES_TASK_3_FROLOVA_O_RADIX_SORT_SIMPLE_MERGE_RADIX_SORT_SIMPLE_MERGE_H_
